...
class FileSystem():
    def load_scene(self, file_name: str):
        # Carrega um arquivo.
        obj_file = ""
        mtl_file = ""
    ...
    def save_scene(self, file_name: str, objects: list[Object]):
        # Escreve um arquivo.
...
class ObjectData():
    ...
    def add_lines(self, faces: list[tuple[int]]):
        # Adiciona faces.
        self._lines += faces

    def add_material(self, material: tuple[float]):
