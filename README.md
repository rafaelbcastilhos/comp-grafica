...
#### Viewport básica
#### Criação e renderização de wireframes
- Na barra lateral direita, na seção de Editor, é necessário selecionar qual objeto deseja criar.
...
#### Edição básica dos wireframes (Posição, escala e rotação)
- Na barra lateral direita, é possível alterar os valores por meio dos botões '+' e '-' para cada eixo.
